  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex flex-col lg:flex-row items-center justify-center lg:relative">
        <div className="flex flex-col md:items-center lg:items-start justify-center order-2 lg:order-1 lg:absolute lg:z-10 lg:-left-60 xl:-left-80">
        ...
        <div className="order-1 lg:order-2 mb-8 lg:mb-0 lg:relative lg:-right-40 xl:-right-80">
          <Me />
        </div>
      </div>
    </div>
